...
public class NetworkHelper {
    ...
    public static boolean isInternetAvailable(Context context) {
        try {
            ...
            Log.e("HelloWorld", "Connexion internet foireuse : ", e);
    ...
    public static HttpResult doGet(String purl, Map<String, String> params, String token)  {
        ...
        if(purl == null){
            Log.e("CesiApp", "URL d'appel vide");
        ...
        try {
            ...
            if(token != null) {
                ...
                conn.setRequestProperty("CesiApp", token);
            }

            // Starts the query
            conn.connect();
            int response = conn.getResponseCode();
            Log.d("NetworkHelper", "Code de réponse : " + response);
    ...
    public static HttpResult doPost(String purl, Map<String, String> params, String token)  {
        ...
        // Un stream pour recevoir la réponse
        InputStream inputStream = null;
        if(purl == null){
            Log.e("CesiApp", "L'URL d'appel est vide");
            throw new RuntimeException("Error url to call is empty");
        }
        ...
        if (params != null && params.size()>0){
            for (Map.Entry<String, String> entry : params.entrySet()){
                try {
                    ...
                    Log.e("CesiApp", "Error adding param", e);
                }
            }
        }
        return sb.toString();
